...
<head>
    ...
    <link href="{{asset('api/css/font-awesome.min.css?v=4.4.0')}}" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    ...
    <script src="{{asset('api/js/plugins/metisMenu/jquery.metisMenu.js')}}"></script>
    <script src="{{asset('api/js/plugins/slimscroll/jquery.slimscroll.min.js')}}"></script>
    <script src="{{asset('api/js/plugins/layer/layer.min.js')}}"></script>

    <!-- 自定义js -->
    <script src="{{asset('api/js/hAdmin.js?v=4.1.0')}}"></script>
    <script type="text/javascript" src="{{asset('api/js/index.js')}}"></script>

    <!-- 第三方插件 -->
    <script src="{{asset('api/js/plugins/pace/pace.min.js')}}"></script>
